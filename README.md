...
```
cd existing_repo
git remote add origin https://gitlab.stud.idi.ntnu.no/scrum_team_3/idatt2106_2024_3_backend.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.stud.idi.ntnu.no/scrum_team_3/idatt2106_2024_3_backend/-/settings/integrations)
...
Paste http://localhost:8080/swagger-ui/index.html into web browser, (8080 is the default port in
