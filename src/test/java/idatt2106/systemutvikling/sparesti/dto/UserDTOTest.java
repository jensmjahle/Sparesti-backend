...
public class UserDTOTest {
  ...
  public void testGetterAndSetter() {
    ...
    userDTO.setBirthDate(LocalDate.parse("1990-01-01"));
    ...
    assertEquals(LocalDate.parse("1990-01-01"), userDTO.getBirthDate());
    ...
    userDTO.setLastName("Doe");
    userDTO.setBirthDate(LocalDate.parse("1995-01-01"));
    ...
    assertEquals("Doe", userDTO.getLastName());
    assertEquals(LocalDate.parse("1995-01-01"), userDTO.getBirthDate());
